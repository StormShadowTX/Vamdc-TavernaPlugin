...
import org.vamdc.taverna.vamdc_taverna_suite.TapXSamsActivity;
import org.vamdc.taverna.vamdc_taverna_suite.TapXSamsActivityConfigurationBean;

public class TapXSamsServiceDesc extends ServiceDescription<TapXSamsActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<TapXSamsActivityConfigurationBean>> getActivityClass() {
		return TapXSamsActivity.class;
	}
	 ...
	 */
	@Override
	public TapXSamsActivityConfigurationBean getActivityConfiguration() {
		TapXSamsActivityConfigurationBean bean = new TapXSamsActivityConfigurationBean();
	...
	public List<String> getPath() {
		...
		return Arrays.asList("VAMDC", "TapXSAMS");
	}
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("vamdcTAP");
	}
