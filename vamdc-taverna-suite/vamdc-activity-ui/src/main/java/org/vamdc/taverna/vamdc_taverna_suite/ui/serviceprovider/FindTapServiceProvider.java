...
public class FindTapServiceProvider implements ServiceDescriptionProvider {
	...
	public void findServiceDescriptionsAsync(
		...
		// of dummy for-loop
		FindTapServiceDesc tapxsamsService = new FindTapServiceDesc();
		tapxsamsService.setDescription("Lists all the Tap Services in the Registry.");
