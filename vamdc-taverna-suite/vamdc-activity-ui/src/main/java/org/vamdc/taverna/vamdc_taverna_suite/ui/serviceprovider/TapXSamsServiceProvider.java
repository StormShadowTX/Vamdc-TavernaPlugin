...
public class TapXSamsServiceProvider implements ServiceDescriptionProvider {
	...
	public void findServiceDescriptionsAsync(
		...
		// of dummy for-loop
		TapXSamsServiceDesc tapxsamsService = new TapXSamsServiceDesc();
		tapxsamsService.setDescription("VAMDC TAP");
