...
import org.vamdc.taverna.vamdc_taverna_suite.SpectColActivity;
import org.vamdc.taverna.vamdc_taverna_suite.SpectColActivityConfigurationBean;
//import org.vamdc.taverna.vamdc_taverna_suite.common.TapQueryHelper;
import net.sf.taverna.raven.appconfig.ApplicationRuntime;

public class SpectColServiceDesc extends ServiceDescription<SpectColActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<SpectColActivityConfigurationBean>> getActivityClass() {
		return SpectColActivity.class;
	}
	 ...
	 */
	@Override
	public SpectColActivityConfigurationBean getActivityConfiguration() {
		SpectColActivityConfigurationBean bean = new SpectColActivityConfigurationBean();
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("vamdcSpectCol");
	}
