...
public class SpectColServiceProvider implements ServiceDescriptionProvider {
...
System.out.println("SYSTEM PATH = " + System.getProperty("java.class.path"));
		...
		// of dummy for-loop
		SpectColServiceDesc spectColService = new SpectColServiceDesc();
		spectColService.setDescription("SpectCol");
		results.add(spectColService);
