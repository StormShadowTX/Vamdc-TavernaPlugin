...
import org.vamdc.taverna.vamdc_taverna_suite.FindTapActivity;
import org.vamdc.taverna.vamdc_taverna_suite.FindTapActivityConfigurationBean;

public class FindTapServiceDesc extends ServiceDescription<FindTapActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<FindTapActivityConfigurationBean>> getActivityClass() {
		return FindTapActivity.class;
	}
	 ...
	 */
	@Override
	public FindTapActivityConfigurationBean getActivityConfiguration() {
		FindTapActivityConfigurationBean bean = new FindTapActivityConfigurationBean();
	...
	public List<String> getPath() {
		...
		return Arrays.asList("VAMDC", "Registry");
	}
	...
	protected List<? extends Object> getIdentifyingData() {
		...
		return Arrays.<Object>asList("vamdcFindTAP");
	}
