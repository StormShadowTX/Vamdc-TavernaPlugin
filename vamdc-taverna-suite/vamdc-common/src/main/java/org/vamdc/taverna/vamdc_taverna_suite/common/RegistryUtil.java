...
public class RegistryUtil {
	...
	public static Registry getRegistry() {
		...
		try {
			...
			if(userConf.exists()) {
				File myceaList = new File(userConf,"vamdc.properties");
				if(myceaList.exists()) {
					System.out.println("loaded from vamdc.properties");
		...
		if(p.containsKey("registry.endpoint")) {
			...
			System.out.println("creating reg:  http://casx019-zone1.ast.cam.ac.uk/registry/services/RegistryQueryv1_0");
			reggie = new Registry("http://casx019-zone1.ast.cam.ac.uk/registry/services/RegistryQueryv1_0");
		}
		return reggie;
	}
