 ...
 * 
 */
public class TapXSamsActivityConfigurationBean implements Serializable {
	...
	private String tapxsamsBase;

	private String query;

	public String getTapXSamsBase() {
		return tapxsamsBase;
	}

	public void setTapXSamsBase(String tapxsamsBase) {
		this.tapxsamsBase = tapxsamsBase;
	}
