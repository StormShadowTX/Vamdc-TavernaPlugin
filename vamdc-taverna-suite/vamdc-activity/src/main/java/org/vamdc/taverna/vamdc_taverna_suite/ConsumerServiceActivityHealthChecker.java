 ...
 * 
 */
public class ConsumerServiceActivityHealthChecker implements
		HealthChecker<ConsumerServiceActivity> {
	...
	public VisitReport visit(ConsumerServiceActivity activity, List<Object> ancestry) {
		ConsumerServiceActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "Consumer service OK", HealthCheck.NO_PROBLEM, subReports);
	}
