 ...
 * 
 */
public class TapXSamsQueryHelperHealthChecker implements
		HealthChecker<TapXSamsQueryHelperActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapXSamsQueryHelperActivity;
	}
	...
	public VisitReport visit(TapXSamsQueryHelperActivity activity, List<Object> ancestry) {
		TapXSamsQueryHelperActivityConfigurationBean config = activity.getConfiguration();
