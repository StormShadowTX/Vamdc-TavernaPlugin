 ...
 * 
 */
public class SpectColActivityHealthChecker implements
		HealthChecker<SpectColActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof SpectColActivity;
	}
	...
	public VisitReport visit(SpectColActivity activity, List<Object> ancestry) {
		SpectColActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "SpectCol service OK", HealthCheck.NO_PROBLEM, subReports);
	}
