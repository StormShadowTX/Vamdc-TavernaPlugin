 ...
 * 
 */
public class TapXSamsActivityHealthChecker implements
		HealthChecker<TapXSamsActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapXSamsActivity;
	}
	...
	public VisitReport visit(TapXSamsActivity activity, List<Object> ancestry) {
		TapXSamsActivityConfigurationBean config = activity.getConfiguration();
		...
		*/
		...
		// empty
		return new VisitReport(HealthCheck.getInstance(), activity, "TAPXSams service OK", HealthCheck.NO_PROBLEM, subReports);
	}
