 ...
 * 
 */
public class TapXSamsOperatorHealthChecker implements
		HealthChecker<TapXSamsOperatorActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TapXSamsOperatorActivity;
	}
	...
	public VisitReport visit(TapXSamsOperatorActivity activity, List<Object> ancestry) {
		TapXSamsOperatorActivityConfigurationBean config = activity.getConfiguration();
